...
version is 4.3.11.
  ...
  2. Clone the repository:
     ...
     ```console
     git clone --recursive https://github.com/Martijn02/prezto.git "${ZDOTDIR:-$HOME}/.zprezto"
     ```

  3. Create a new Zsh configuration by symlinkning the Zsh configuration files
     provided:
